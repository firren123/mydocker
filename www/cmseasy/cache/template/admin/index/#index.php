...
<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
<div class="quick-btn">
<a href="<?php echo $base_url;?>/index.php?case=config&act=system&set=sms&admin_dir=<?php echo get('admin_dir');?>&site=default" class="q4">短信管理</a>
</div>
</div>
...
[ 联系客服： <span id="__buy"><a href="tencent://Message/?Uin=871148347&websiteName=<?php echo get('site_url');?>=&Menu=yes" target="_blank"><span style="color:green;">购买咨询</span></a></span> ]<br />
