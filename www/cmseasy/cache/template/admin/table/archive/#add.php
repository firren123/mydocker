...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('typeid',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::input("vote[$i]",vote::title(@$data['aid'],$i));?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::input("vote_image[$i]",vote::img(@$data['aid'],$i));?>
