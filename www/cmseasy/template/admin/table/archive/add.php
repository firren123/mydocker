...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<span class="hotspot"><img id="color_btn" width="14" height="14" src="{$base_url}/images/admin/colorpicker.png" style="cursor:pointer;" /><input id="color" name="color" type="hidden" /></span>  <span class="hotspot"><input name="strong" type="checkbox" value="1" {if $data['strong']==1}checked{/if} /></span>{form::getform('title',$form,$field,$data)}
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="alert alert-warning alert-danger" role="alert">
      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
	<span class="glyphicon glyphicon-warning-sign"></span>	<strong>投票</strong> 	[	可在内页增加对该内容投票选项！]	
    </div>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
{form::input("vote[$i]",vote::title(@$data['aid'],$i))}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
{form::input("vote_image[$i]",vote::img(@$data['aid'],$i))}
