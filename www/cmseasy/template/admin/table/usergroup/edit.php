...
<table width="100%" align="center" class="usergroup-table table">
            <tr class="trstyle2">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td colspan="4" class="col" valign="center">
                  ...
                  <tr>
                    <td colspan="4" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="content" type="checkbox" name="powerlist[category]" {getchecked($data['powerlist'],'category')} value="1" id="content_category">
                      栏目管理</td>
                    <td colspan="3" class="col" valign="center">
					<table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          ...
                          <td class="unit"><input class="content content_category" type="checkbox" name="powerlist[category_htmlrule]" {getchecked($data['powerlist'],'category_htmlrule')} value="1" />
                            栏目url规则</td>
                          <td class="unit"><input class="content content_category" type="checkbox" name="powerlist[category_import]" {getchecked($data['powerlist'],'category_import')} value="1" />
                            批量导入</td>
                        </tr>
                      </table>
					  </td>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="content" type="checkbox" name="powerlist[archive]" {getchecked($data['powerlist'],'archive')} value="1" id="content_archive">
                      内容管理</td>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="content" type="checkbox" name="powerlist[mtype]" {getchecked($data['powerlist'],'mtype')} value="1" id="content_mtype">
                      分类管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="content" type="checkbox" name="powerlist[special]" {getchecked($data['powerlist'],'special')} value="1" id="content_special">
                      专题管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="user" type="checkbox" name="powerlist[user_manage]" {getchecked($data['powerlist'],'user_manage')} value="1" id="user_manage">
                      用户管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="user" type="checkbox" name="powerlist[user_group]" {getchecked($data['powerlist'],'user_group')} value="1" id="user_group">
                      用户组管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="order" type="checkbox" name="powerlist[order_manage]" {getchecked($data['powerlist'],'order_manage')} value="1" id="order_manage">
                      订单管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="func" type="checkbox" name="powerlist[func_announc]" {getchecked($data['powerlist'],'func_announc')} value="1" id="func_announc">
                      公告管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="func" type="checkbox" name="powerlist[func_book]" {getchecked($data['powerlist'],'func_book')} value="1" id="func_book">
                      留言管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="func" type="checkbox" name="powerlist[func_comment]" {getchecked($data['powerlist'],'func_comment')} value="1" id="func_comment">
                      评论管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="func" type="checkbox" name="powerlist[func_ballot]" {getchecked($data['powerlist'],'func_ballot')} value="1" id="func_ballot">
                      投票管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="func" type="checkbox" name="powerlist[func_data]" {getchecked($data['powerlist'],'func_data')} value="1" id="func_data">
                    数据管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="templates" type="checkbox" name="powerlist[template_manage]" {getchecked($data['powerlist'],'template_manage')} value="1" id="template_manage">
                      模板管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="templates" type="checkbox" name="powerlist[templatetag_add]" {getchecked($data['powerlist'],'templatetag_add')} value="1" id="templatetag_add">
                      添加标签</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="templates" type="checkbox" name="powerlist[templatetag_list]" {getchecked($data['powerlist'],'templatetag_list')} value="1" id="templatetag_list">
                      标签列表</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="seo" type="checkbox" name="powerlist[seo_weixin]" {getchecked($data['powerlist'],'seo_weixin')} value="1" id="seo_weixin">
                      公众号管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="seo" type="checkbox" name="powerlist[seo_status]" {getchecked($data['powerlist'],'seo_status')} value="1" id="seo_status">
                      蜘蛛管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="seo" type="checkbox" name="powerlist[seo_linkword]" {getchecked($data['powerlist'],'seo_linkword')} value="1" id="seo_linkword">
                      内容链接管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="seo" type="checkbox" name="powerlist[seo_friendlink]" {getchecked($data['powerlist'],'seo_friendlink')} value="1" id="seo_friendlink">
                      友情链接管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="seo" type="checkbox" name="powerlist[user_union]" {getchecked($data['powerlist'],'user_union')} value="1" id="user_union">
                      推广联盟</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="seo" type="checkbox" name="powerlist[seo_mail]" {getchecked($data['powerlist'],'seo_mail')} value="1" id="seo_mail">
                    邮件管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="defined" type="checkbox" name="powerlist[defined_field_content]" {getchecked($data['powerlist'],'defined_field_content')} value="1" id="defined_field_content">
                      内容字段</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="defined" type="checkbox" name="powerlist[defined_field_user]" {getchecked($data['powerlist'],'defined_field_user')} value="1" id="defined_field_user">
                      用户字段</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="defined" type="checkbox" name="powerlist[defined_form]" {getchecked($data['powerlist'],'defined_form')} value="1" id="defined_form">
                      管理表单</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="cache" type="checkbox" name="powerlist[cache_manage]" {getchecked($data['powerlist'],'cache_manage')} value="1" id="cache_manage">
                      生成管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
...
GOOGLE生成</td>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center" style="background:#f2f2f2;"><input class="cache" type="checkbox" name="powerlist[cache_update]" {getchecked($data['powerlist'],'cache_update')} value="1" id="cache_update">
                    更新缓存</td>
